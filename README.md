...
- У микросхемы зещелки U23 74LS374 необходимо расположить дополнительный конденсатор ~220пФ между первой ножкой и землей. Можно навесным монтажом, можно снизу платы используя SMD тип конденсатора. ![](images/ls374.PNG) <img src="images/photo_2025-01-28_18-19-14.jpg" width="480">
...
- [x] Плата работает со слотами, с дополнительными платами расширения [Dan II controller](https://github.com/profdc9/Apple2Card), [A2VGA+Mockingboard card](https://github.com/Tronix286/a2vga_audio);
  - [ ] Проверить с другими картами расширений (пока отсутствуют);<br />
...
- [ ] Контроллер клавиатуры (в разработке);
  ...
  - [ ] Чертеж и заказ печатных плат;<br />
