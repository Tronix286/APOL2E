...
- Прошивка для знакогенератора U24 (27C64) - Применена 8кб микросхема, поэтому имеется поддержка "двухязыковых" евро-комптьютеров. Скачать какую-то можно здесь:<br />
...
- [x] Плата работает со слотами, с дополнительными платами расширения [Dan II controller](https://github.com/profdc9/Apple2Card), [A2VGA+Mockingboard card](https://github.com/Tronix286/a2vga_audio);
