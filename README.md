...
- [x] Плата работает со слотами, с дополнительными платами расширения [Dan II controller](https://github.com/profdc9/Apple2Card), [A2VGA+Mockingboard card](https://github.com/Tronix286/a2vga_audio); <br />
  ...
  - [X] Проверить с другими картами расширений. Проверена со стандартным контроллером флоппи-дисков;
...
<img src="images/P1140211.jpg" width="35%"></img> <img src="images/P1140212.JPG" width="35%"></img>

<details> <summary>Процесс разработки клавиатурного контроллера</summary> <img src="images/photo_2025-02-01_17-36-43.jpg" width="45%"></img> <img src="images/photo_2025-02-01_18-00-28.jpg" width="45%"></img> <img src="images/photo_2025-02-01_18-02-27.jpg" width="45%"></img> <img src="images/photo_2025-02-01_18-02-48.jpg" width="45%"></img> 
</details>

- [X] Исправление некоторых ошибок платы ревезии 1_0b и создание новой платы ревизии 1_1.<br />
Общий вид собранной платы rev1.1 и платы с установленным клавиатурным контроллером:<br /> <img src="images/P1140218.jpg" width="46%"> <img src="images/P1140207.jpg" width="45%"><br />
История изменений по сравнению с версией rev1_0b:
  - [X] Микросхема U29 заменена с 74LS74 на 74S109
  - [X] Исправлен рисунок на шелке у транзистора Q3 2N3904.
  - [X] У микросхемы зещелки U23 74LS374 расположен дополнительный конденсатор ~220пФ между первой ножкой и землей.
  - [X] Скорректированно местоположение отверстия под стойку в нижнем левом углу платы для установки в оригинальном корпусе Apple IIe.
  - [X] Разъем PS/2 клавиатуры развернут внутрь платы для возможности подключить PS/2 клавиатуру когда плата находится в корпусе Apple IIe.
  - [X] Установлен дополнительный штыревой разъем J9 с сигналами PS/2 клавиатуры для возможности подключения выносного PS/2 разъема на корпус Apple IIe.

- [X] Исправление некоторых ошибок платы ревезии 1_1 и создание новой платы ревизии 1_2.<br />
Общий вид собранной платы rev1.2 и платы с установленным клавиатурным контроллером:<br /> <img src="images/P1140243.jpg" width="46%"> <img src="images/P1140245.jpg" width="45%"><br />
История изменений по сравнению с версией rev1_1:
  - [X] У микросхемы U29 на шелке обозначено ее наименование - 74S109 (раньше отсутсвовало);
  - [X] У подстроечного конденсатора C52 КПК-КП появилось дополнительное посадочное место для установки зарубежных подстроечных конденсаторов типа TZ03;
  - [X] Скорректированы даты в названии платы, добавлен 2026 год.
...
- Список деталей BOM на плату rev1.0b здесь: [.csv версия](pdfs/bom_rev1_0b.csv) [.ods OpenOffice версия](pdfs/bom_rev1_0b.ods); на плату rev1.1/rev1.2 здесь: [.csv версия](pdfs/bom_rev1_1.csv)
- Монтажная схема расположения деталей на плату rev1.0b здесь: [монтажная схема rev1.0b](images/pcb_montag_rev1_0b.png); на плату rev1.1/rev1.2 здесь: [монтажная схема rev1.1](images/pcb_montag_rev1_1.png)
- Схема принципиальная на плату rev1.0b здесь: [схема принципиальная rev1.0b](pdfs/circuit_rev1_0b.pdf); на плату rev1.1/rev1.2 здесь: [схема принципиальная rev1.1](pdfs/circuit_rev1_1.pdf); на плату rev1.2 с возможностью поиска по надписям (ctrl+f) здесь: [схема принципиальная rev1.2](pdfs/circuit_rev1_2.pdf)
...
[IOU здесь commit 41ea87d Jun 26, 2025](firmware/IOU_41ea87d.pof)<br />
[MMU здесь commit 41ea87d Jun 26, 2025](firmware/MMU.pof) <details> <summary>Старые версии прошивок CPLD:</summary>
[IOU здесь commit 981ad91 Jan 10, 2025](firmware/IOU.pof)<br />
[MMU здесь commit 981ad91 Jan 10, 2025](firmware/MMU.pof)</details>
...
Клавиатурный контроллер расположен на отдельной дополнительной плате, которая устанавливается в основную плату с помощью штыревых соединителей типа PLS в посадочное место U21. В rev1.0b и rev1.1/rev1.2 это посадочное место маркировано как ATMEGA328P-PU, так как предполагалось что туда можно будет установить один лишь микроконтроллер Atmega без дополнительной обвязки в виде защелки и обслуживающий только лишь PS/2 клавиатуру. В дальнейшем в ходе разработке было принято решение вместо этого вынести клавиатурный контроллер на отдельную плату, который сможет обслуживать и PS/2 и оригинальную матричную клавиатуру Apple IIe. Отлаживать, проверять и запускать основную плату можно и без контроллера клавиатуры, для этого временно:
...
- схема клавиатурного контроллера [rev1_0b](pdfs/kbdctrl_rev1_0.pdf); [rev1_1](pdfs/kbdctrl_rev1_1.pdf)
- монтажная схема клавиатурного контроллера [rev1_0b](images/kbd_montag_rev1_0b.png); [rev1_1](images/kbd_montag_rev1_1.png)
- список деталей BOM на клавиатурный контроллер [файл .csv rev1_0b](pdfs/kbd_bom_rev1_0b.csv); Для rev1_1 все то же самое, плюс два резистора 10k.
- [прошивка AT89C52 v2.58](firmware/apple_kbd.hex) Первый релиз.
- [прошивка AT89C52 v2.58h](firmware/apple_kbd_2_58h.hex) Исправлено определение некоторых PS/2 клавиатур - увеличена задержка ожидания ответа от клавиатуры при включении.
...
<img src="images/kbd_langsw.PNG" width="15%"></br>
...
<img src="images/kbd_uart.PNG"  width="15%"> <img src="images/kbd_uart_term.PNG"></br>
...
- Присутствуют "лишние" компоненты C33 (0.1uF), J7 (штырки 3 пин) (рудимент от идеи использовать Atmega в качестве клавиатурного контроллера).

## Errata или уже найденные ошибки на плате rev1.2
- Разъем U21 под плату клавиатурного контроллера до сих пор имеет на шелке наименование Atmega328P-PU. Должно быть KBD-Controller.
- Присутствуют "лишние" компоненты C33 (0.1uF), J7 (штырки 3 пин) (рудимент от идеи использовать Atmega в качестве клавиатурного контроллера).
