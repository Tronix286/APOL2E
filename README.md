...
Контроллер клавиатуры выполнен на отдельной плате, которая посредством штыревых соединителей соединяется с основной платой. На материнской плате в посадочное место U21 впаиваются гнездовые соединители типа PBS 1x14 2.54" (мама), а на плате контроллера в разъем MB-connector соединители типа PLS 1x14 2.54" (папа). </br>
<img src="images/photo_2025-02-03_19-13-09.jpg" width="45%"></img> <img src="images/photo_2025-02-03_19-13-13.jpg" width="45%"></img> 
