...
<img src="images/kbd_langsw.PNG"></br>

Для отладочных целей на плате клавиатурного контроллера выведен разъем J2 для подключения UART (TTL, 5V), его распиновка:
</br>
<img src="images/kbd_uart.PNG"></br>
Параметры порта: 2400 8N1. В процессе работы туда выводится некоторая отладочная информация, которая может выглядеть примерно так:
</br>
<img src="images/kbd_uart_term.PNG"></br>
